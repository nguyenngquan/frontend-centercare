...
export default class extends BaseApi {
  getAll = async () => {
    try {
      let urlBase = this.makeUrl("baitaps");
  ...
  getById = async (id) => {
    try {
      let urlBase = this.makeUrl("baitaps", id);
      let result = await this.execute_get(urlBase);
      return result;
    } catch (error) {
      console.log(error);
  ...
  getByIdHocVien = async (id = "") => {
    try {
      let urlBase = this.makeUrl("baitaps", "hocvien", id.toString());
      let result = await this.execute_get(urlBase);
      return result;
    } catch (error) {
      console.log(error);
  ...
  getByIdLop = async (id = "") => {
    try {
      let urlBase = this.makeUrl("baitaps", "lop", id.toString());
      let result = await this.execute_get(urlBase);
      return result;
    } catch (error) {
      console.log(error);

...
export default class extends BaseApi {
  getAll = async () => {
    try {
      let urlBase = this.makeUrl("nhucauhocs");
  ...
  getById = async (id = "") => {
    try {
      let urlBase = this.makeUrl("nhucauhocs", id.toString());
      let result = await this.execute_get(urlBase);
      return result;
    } catch (error) {
      console.log(error);
  ...
  delete = async (id) => {
    try {
      let urlBase = this.makeUrl("nhucauhocs", id);
  ...
  getByIdHocVien = async (id) => {
    try {
      let urlBase = this.makeUrl("nhucauhocs", "hocvien", id.toString());
      let result = await this.execute_get(urlBase);
      return result;
    } catch (error) {
      console.log(error);
